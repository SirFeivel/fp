const translations = {
  de: {
    ...
    extraction: {
      title: "Grundriss-Extraktion",
      extractFloorPlan: "Grundriss extrahieren",
      validationTitle: "Extrahierte Räume überprüfen",
      roomsDetected: "Räume erkannt",
      scale: "Maßstab",
      confidence: "Genauigkeit",
      confidenceGood: "Gut",
      confidenceMedium: "Mittel",
      confidenceLow: "Niedrig",
      helpText: "Überprüfen Sie die erkannten Räume und passen Sie sie bei Bedarf an:",
      helpDrag: "Ziehen Sie Eckpunkte, um Raumgrenzen anzupassen",
      helpClick: "Klicken Sie auf einen Raum, um ihn zu bearbeiten",
      helpDelete: "Löschen Sie falsch erkannte Räume",
      import: "Importieren",
      editRoom: "Raum bearbeiten",
      deleteRoom: "Raum löschen",
      processing: "Verarbeite Grundriss...",
      phasePreprocessing: "Bild wird vorbereitet",
      phaseOCR: "Text wird erkannt",
      phaseWalls: "Wände werden erkannt",
      phaseCalibration: "Maßstab wird kalibriert",
      phaseRooms: "Räume werden erkannt",
      phaseNaming: "Namen werden zugewiesen",
      phaseComplete: "Fertig",
      errorNoWalls: "Keine Wände erkannt. Stellen Sie sicher, dass der Grundriss klare Wandlinien enthält.",
      errorNoRooms: "Keine Räume erkannt. Das Bild enthält möglicherweise keine geschlossenen Räume.",
      errorCalibrationFailed: "Automatische Kalibrierung fehlgeschlagen: {error}",
      imported: "Grundriss importiert",
  ...
  en: {
    ...
    extraction: {
      title: "Floor Plan Extraction",
      extractFloorPlan: "Extract Floor Plan",
      validationTitle: "Review Extracted Rooms",
      ...
      confidenceLow: "Low",
      helpText: "Review the detected rooms and adjust if needed:",
      helpDrag: "Drag vertices to adjust room boundaries",
      helpClick: "Click a room to edit it",
      helpDelete: "Delete incorrectly detected rooms",
      import: "Import",
      editRoom: "Edit Room",
      deleteRoom: "Delete Room",
      processing: "Processing floor plan...",
      phasePreprocessing: "Preparing image",
      phaseOCR: "Recognizing text",
      phaseWalls: "Detecting walls",
      phaseCalibration: "Calibrating scale",
      phaseRooms: "Detecting rooms",
      phaseNaming: "Assigning names",
      phaseComplete: "Complete",
      errorNoWalls: "No walls detected. Ensure the floor plan has clear wall lines.",
      errorNoRooms: "No rooms detected. The image may not contain enclosed spaces.",
      errorCalibrationFailed: "Auto-calibration failed: {error}",
      imported: "Floor plan imported",
