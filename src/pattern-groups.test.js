  ...
  describe("tilesForPreview pattern inheritance", () => {
    it("child room uses origin room's herringbone pattern instead of its own grid pattern", () => {
      ...
      const originRoom = {
        ...
        widthCm: 300,
        heightCm: 300,
        sections: [{ id: "s1", x: 0, y: 0, widthCm: 300, heightCm: 300 }],
        exclusions: [],
      ...
      const childRoom = {
        ...
        widthCm: 300,
        heightCm: 300,
        sections: [{ id: "s2", x: 0, y: 0, widthCm: 300, heightCm: 300 }],
        exclusions: [],
        tile: { widthCm: 40, heightCm: 20, shape: "rect" },
        grout: { widthCm: 0.2, colorHex: "#ffffff" },
        pattern: {
        ...
        rooms: [
          {
            ...
            widthCm: 300,
            heightCm: 300,
            sections: [{ id: "s0", x: 0, y: 0, widthCm: 300, heightCm: 300 }],
            exclusions: [],
            tile: { widthCm: 40, heightCm: 20, shape: "rect" },
            grout: { widthCm: 0.2, colorHex: "#ffffff" },
            pattern: {
          ...
          },
          {
            ...
            widthCm: 219,
            heightCm: 237,
            sections: [{ id: "s3", x: 0, y: 0, widthCm: 219, heightCm: 237 }],
            exclusions: [],
            tile: { widthCm: 40, heightCm: 20, shape: "rect" },
            grout: { widthCm: 0.2, colorHex: "#ffffff" },
            pattern: {
